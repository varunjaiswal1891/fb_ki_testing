...
public class SignUpService {
	...
	public boolean addUserService(User u1)
	{
        ...
        try 
        {
            ...
            new File("/home/umesh/git/fb_ki_testing/src/main/webapp/users/"+u1.getEmailID()+"/images/").mkdirs();
            new File("/home/umesh/git/fb_ki_testing/src/main/webapp/users/"+u1.getEmailID()+"/groups/").mkdirs();
            return true;
        }}
        }
        catch (Exception e) 
