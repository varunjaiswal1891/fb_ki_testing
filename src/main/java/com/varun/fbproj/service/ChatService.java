...
public static ArrayList<Chat> getAll(Chat obj)//Gets all the messages between the logged in person and the person whose chat window is open
{
boolean check=false;
...
return null;
   ...
   public static ArrayList<Chat> fetchNew(Chat c)//The status of message is changed to delivered by the sender to the receiver
{
boolean check=false;
   try{
 while(check!=true){
...
return null;
   ...
   public static boolean postMsg(Chat c)//This is being called when the sender sends the message and the data is send to the table
{
boolean check=false;
   try{
 while(check!=true){
...
return false;
   ...
   public static boolean deleteMsg(Chat c)//The message gets deleted from here when user deletes the particular message.
{
boolean check=false;
   try{
 while(check!=true){
...
return false;
   ...
   public static ArrayList<Chat> fetchAllConversations(String email)//Fetches all the conversation between the receiver and the sender.
{
boolean check=false;
   try{
 while(check!=true){
...
public static String deleteyourAllMessage(String emailID,String friendID)//Deletes all the messages by the person who is logged in.
   {
boolean check=false;
   try {
 while(check!=true){
...
public static String deleteyouroneMessage(String emailID,String friendID, int chatID)//Deletes a single message by the person who is logged in. 
{
boolean check=false;
   try {
 while(check!=true){
